...
load_child_theme_textdomain(genchild);

add_action('genesis_setup', 'genchild_setup',15);
/**
 * Theme setup.
 * 
 ...
 * @since 1.0.0
 */
function genchild_setup() {
    
    //Define theme constants.
    define( 'CHILD_THEME_NAME', 'genchild');
    define('CHILD_THEME_URL', 'http://webstudioplace.dev/genchild');
